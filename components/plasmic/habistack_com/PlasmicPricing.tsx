...
import Plan from "../../Plan"; // plasmic-import: pqYw2YQIp2Bj/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: olcIRrYgfE_V/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__kv5XI)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__kIKbw)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button___7EfsP)}
              ...
              <div className={classNames(projectcss.all, sty.column__a9ESr)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__uoMQo)}
                  description={
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__ivEg6)}
                    color={"blue" as const}
                  >
                    {"Get started"}
                  </Button>
              ...
              <div className={classNames(projectcss.all, sty.column__hbMl4)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___2Il40)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__kZtwt)}
                    color={"outlineBlue" as const}
                  >
                    {"Get started"}
                  </Button>
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__ovQlh)}
            >
              <Faq
                className={classNames("__wab_instance", sty.faq__yTUm)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq___77Mf)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__uK1Lh)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
